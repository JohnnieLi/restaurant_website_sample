   ...
   try{
     ...
     $errormessage = Array();
      ...
      if(isset($_POST['customerName'])||
        ...
        if($_POST['phoneNumber']!=""&& strlen($_POST['phoneNumber'])!=10 ){
            $haserror = true;
        ...
        if($_POST['emailAddress']!=""&&!(strlen($_POST['emailAddress']) > 6 && preg_match("/^[\w\-\.]+@[\w\-]+(\.\w+)+$/",$_POST['emailAddress']))){
            $haserror = true;
            $errormessage['emailAddress'] = "Please enter an appropriate Email Address.";
        }
